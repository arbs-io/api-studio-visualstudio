...
namespace ApiStudioIO
{
	...
	/// </summary>
	internal partial class ApiStudioIODocView : ApiStudioIODocViewBase
	{
		/// <summary>
		/// Constructs a new ApiStudioIODocView.
		/// </summary>
		public ApiStudioIODocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class ApiStudioIODocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new ApiStudioIODocView.
		/// </summary>
		protected ApiStudioIODocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			ApiStudioIODocDataBase docData = this.DocData as ApiStudioIODocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for ApiStudioIODocViewBase should be an ApiStudioIODocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::ApiStudioIO.ApiStudioDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::ApiStudioIO.ApiStudioDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::ApiStudioIO.ApiStudioIOToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::ApiStudioIO.ApiStudioIOToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.ApiStudioIODiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::ApiStudioIO.ApiStudioIOHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::ApiStudioIO.ApiStudioIOHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::ApiStudioIO.ApiStudioIOHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
