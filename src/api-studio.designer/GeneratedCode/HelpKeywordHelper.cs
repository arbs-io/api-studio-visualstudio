...
namespace ApiStudioIO
{
	...
	/// </remarks>
	public partial class ApiStudioIOHelpKeywordHelper : ApiStudioIOHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new ApiStudioIOHelpKeywordHelper.
		/// </summary>
		protected ApiStudioIOHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the ApiStudioIOHelpKeywordHelper.
		/// </summary>
		public static ApiStudioIOHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class ApiStudioIOHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new ApiStudioIOHelpKeywordHelperBase.
		/// </summary>
		protected ApiStudioIOHelpKeywordHelperBase()
			: base() { }
