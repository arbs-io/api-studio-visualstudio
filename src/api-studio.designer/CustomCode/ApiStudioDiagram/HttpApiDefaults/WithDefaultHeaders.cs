...
namespace ApiStudioIO.HttpApiDefaults
{
    internal static class HttpApiHeaderExtension
    {
        ...
        {
            var managedList = ApiStudioUserSettingsStore.Instance.Data.DefaultHeaders.Request.Values.Select(headersRequest => new HttpResourceHeaderRequest
                {
        ...
        private static void CreateDefaultResponseHeader(HttpApi httpApi)
        {
            ...
            managedList.AddRange(ApiStudioUserSettingsStore.Instance.Data.DefaultHeaders.Response.Values.Select(headersResponse => new HttpResourceHeaderResponse
            {
        ...
        private static IEnumerable<HttpResourceHeaderResponse> AddResponseHeaderLocation(HttpApi httpApi)
        {
            var managedList = new List<HttpResourceHeaderResponse>();
