  ...
  <Classes>
    <DomainClass Id="8aba1eb0-dc24-44f9-8751-d236150d7e4e" Description="Enterprise Application Diagram for component interface definition" Name="ApiStudio" DisplayName="Api Studio" Namespace="ApiStudioIO" HasCustomConstructor="true">
      <Properties>
        ...
        <DomainProperty Id="fae6e846-4cfe-42bc-8ccb-83e949c427c9" Description="The url which provides additional information about the solution or team" Name="ContactUrl" DisplayName="Contact Url" DefaultValue="https://api.api-studio.io/" Category="Specification">
          <Type>
            <ExternalTypeMoniker Name="/System/String" />
          </Type>
        </DomainProperty>
        ...
        <DomainProperty Id="5c9bccd9-1593-4db8-819f-4ca5e84ec02b" Description="Api Keys are header values which should be validated by the Api Gateway or Backend service. Typically used within API Products to determine the subscription level of the consumer. For example [ProductName]-Api-Key." Name="SecurityApiKey" DisplayName="Api Key" DefaultValue="" Category="Security">
          <Type>
            <ExternalTypeMoniker Name="/System/String" />
          </Type>
        </DomainProperty>
