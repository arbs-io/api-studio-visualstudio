namespace Store
{
    ...
    public partial class HttpDeactivateOrder
    {
        [Function(nameof(HttpDeactivateOrder.DeactivateOrder))]
        [OpenApiOperation(operationId: "DeactivateOrder", tags: new[] { "Store" }, Summary = "DeactivateOrder", Description = "This is a description of the rest verbs actions", Visibility = OpenApiVisibilityType.Important)]
        ...
        public async Task<HttpResponseData> DeactivateOrder(
