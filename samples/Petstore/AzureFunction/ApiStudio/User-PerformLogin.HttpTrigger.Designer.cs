namespace User
{
    ...
    {
        [Function(nameof(HttpPerformLogin.PerformLogin))]
        [OpenApiOperation(operationId: "PerformLogin", tags: new[] { "User" }, Summary = "PerformLogin", Description = "This is a description of the rest verbs actions", Visibility = OpenApiVisibilityType.Important)]
        ...
        public async Task<HttpResponseData> PerformLogin(
            [HttpTrigger(AuthorizationLevel.Anonymous, "POST", 
            Route = "users/login")] HttpRequestData httpRequestData)
        {
