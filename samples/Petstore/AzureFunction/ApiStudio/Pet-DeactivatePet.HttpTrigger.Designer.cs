namespace Pet
{
    ...
    public partial class HttpDeactivatePet
    {
        [Function(nameof(HttpDeactivatePet.DeactivatePet))]
        [OpenApiOperation(operationId: "DeactivatePet", tags: new[] { "Pet" }, Summary = "DeactivatePet", Description = "This is a description of the rest verbs actions", Visibility = OpenApiVisibilityType.Important)]
        ...
        public async Task<HttpResponseData> DeactivatePet(
