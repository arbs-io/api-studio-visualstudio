namespace User
{
    ...
    public partial class HttpChangeUser
    {
        [Function(nameof(HttpChangeUser.ChangeUser))]
        [OpenApiOperation(operationId: "ChangeUser", tags: new[] { "User" }, Summary = "ChangeUser", Description = "This is a description of the rest verbs actions", Visibility = OpenApiVisibilityType.Important)]
		...
		[OpenApiRequestBody(contentType: "application/json", bodyType: typeof(User), Required = true, Description = "")]
		[OpenApiParameter(name: "Username", In = ParameterLocation.Path, Required = true, Type = typeof(Guid), Summary = "A unique, immutable identifier that identifies a resource", Description = "A unique, immutable identifier that identifies a resource", Visibility = OpenApiVisibilityType.Important)]
		[OpenApiResponseWithoutBody(statusCode: HttpStatusCode.Accepted, Summary = "Accepted", Description = "Accepted", CustomHeaderType = typeof(ResponseHeaderOnSuccess))]
        ...
        public async Task<HttpResponseData> ChangeUser(
            [HttpTrigger(AuthorizationLevel.Anonymous, "PUT", 
            Route = "users/{Username}")] HttpRequestData httpRequestData)
        {
