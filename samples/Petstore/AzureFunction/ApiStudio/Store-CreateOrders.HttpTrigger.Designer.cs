namespace Store
{
    ...
    {
        [Function(nameof(HttpCreateOrders.CreateOrders))]
        [OpenApiOperation(operationId: "CreateOrders", tags: new[] { "Store" }, Summary = "CreateOrders", Description = "This is a description of the rest verbs actions", Visibility = OpenApiVisibilityType.Important)]
		...
		[OpenApiRequestBody(contentType: "application/json", bodyType: typeof(Order), Required = true, Description = "")]
		[OpenApiResponseWithBody(statusCode: HttpStatusCode.Created, contentType: "application/json", bodyType: typeof(Order), Summary = "Created", Description = "Created", CustomHeaderType = typeof(ResponseHeaderOnSuccess))]
        ...
        public async Task<HttpResponseData> CreateOrders(
            [HttpTrigger(AuthorizationLevel.Anonymous, "POST", 
            Route = "store/orders")] HttpRequestData httpRequestData)
        {
