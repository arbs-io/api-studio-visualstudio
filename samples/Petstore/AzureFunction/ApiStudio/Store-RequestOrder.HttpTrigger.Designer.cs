namespace Store
{
    ...
    public partial class HttpRequestOrder
    {
		...
		[OpenApiResponseWithBody(statusCode: HttpStatusCode.OK, contentType: "application/json", bodyType: typeof(Order), Summary = "OK", Description = "OK", CustomHeaderType = typeof(ResponseHeaderOnSuccess))]
