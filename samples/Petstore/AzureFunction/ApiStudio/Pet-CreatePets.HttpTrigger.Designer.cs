namespace Pet
{
    ...
    public partial class HttpCreatePets
    {
        [Function(nameof(HttpCreatePets.CreatePets))]
        [OpenApiOperation(operationId: "CreatePets", tags: new[] { "Pet" }, Summary = "CreatePets", Description = "This is a description of the rest verbs actions", Visibility = OpenApiVisibilityType.Important)]
		...
		[OpenApiResponseWithBody(statusCode: HttpStatusCode.Created, contentType: "application/json", bodyType: typeof(Pet), Summary = "Created", Description = "Created", CustomHeaderType = typeof(ResponseHeaderOnSuccess))]
        ...
        public async Task<HttpResponseData> CreatePets(
            [HttpTrigger(AuthorizationLevel.Anonymous, "POST", 
            Route = "pets")] HttpRequestData httpRequestData)
        {
