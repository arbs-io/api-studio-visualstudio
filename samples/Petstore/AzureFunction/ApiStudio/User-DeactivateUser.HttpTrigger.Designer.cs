namespace User
{
    ...
    {
        [Function(nameof(HttpDeactivateUser.DeactivateUser))]
        [OpenApiOperation(operationId: "DeactivateUser", tags: new[] { "User" }, Summary = "DeactivateUser", Description = "This is a description of the rest verbs actions", Visibility = OpenApiVisibilityType.Important)]
