namespace Pet
{
    ...
    {
        [Function(nameof(HttpUploadImage.UploadImage))]
        [OpenApiOperation(operationId: "UploadImage", tags: new[] { "Pet" }, Summary = "UploadImage", Description = "This is a description of the rest verbs actions", Visibility = OpenApiVisibilityType.Important)]
		...
		[OpenApiResponseWithBody(statusCode: HttpStatusCode.Created, contentType: "application/json", bodyType: typeof(ModelApiResponse), Summary = "Created", Description = "Created", CustomHeaderType = typeof(ResponseHeaderOnSuccess))]
        ...
        public async Task<HttpResponseData> UploadImage(
            ...
            Route = "pets/{PetId}/image")] HttpRequestData httpRequestData)
        {
