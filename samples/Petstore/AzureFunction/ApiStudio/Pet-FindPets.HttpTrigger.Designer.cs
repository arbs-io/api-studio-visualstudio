namespace Pet
{
    ...
    {
        [Function(nameof(HttpFindPets.FindPets))]
        [OpenApiOperation(operationId: "FindPets", tags: new[] { "Pet" }, Summary = "FindPets", Description = "This is a description of the rest verbs actions", Visibility = OpenApiVisibilityType.Important)]
        ...
        public async Task<HttpResponseData> FindPets(
