namespace User
{
    ...
    {
        [Function(nameof(HttpCreateUsers.CreateUsers))]
        [OpenApiOperation(operationId: "CreateUsers", tags: new[] { "User" }, Summary = "CreateUsers", Description = "This is a description of the rest verbs actions", Visibility = OpenApiVisibilityType.Important)]
		...
		[OpenApiResponseWithBody(statusCode: HttpStatusCode.Created, contentType: "application/json", bodyType: typeof(User), Summary = "Created", Description = "Created", CustomHeaderType = typeof(ResponseHeaderOnSuccess))]
        ...
        public async Task<HttpResponseData> CreateUsers(
            [HttpTrigger(AuthorizationLevel.Anonymous, "POST", 
            Route = "users")] HttpRequestData httpRequestData)
        {
