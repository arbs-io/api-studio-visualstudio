namespace User
{
    ...
    public partial class HttpPerformLogout
    {
        [Function(nameof(HttpPerformLogout.PerformLogout))]
        [OpenApiOperation(operationId: "PerformLogout", tags: new[] { "User" }, Summary = "PerformLogout", Description = "This is a description of the rest verbs actions", Visibility = OpenApiVisibilityType.Important)]
        ...
        public async Task<HttpResponseData> PerformLogout(
            [HttpTrigger(AuthorizationLevel.Anonymous, "POST", 
            Route = "users/logout")] HttpRequestData httpRequestData)
        {
