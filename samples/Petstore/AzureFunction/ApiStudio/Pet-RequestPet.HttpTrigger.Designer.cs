namespace Pet
{
    ...
    {
        [Function(nameof(HttpRequestPet.RequestPet))]
        [OpenApiOperation(operationId: "RequestPet", tags: new[] { "Pet" }, Summary = "RequestPet", Description = "This is a description of the rest verbs actions", Visibility = OpenApiVisibilityType.Important)]
		...
		[OpenApiResponseWithBody(statusCode: HttpStatusCode.OK, contentType: "application/json", bodyType: typeof(Pet), Summary = "OK", Description = "OK", CustomHeaderType = typeof(ResponseHeaderOnSuccess))]
        ...
        public async Task<HttpResponseData> RequestPet(
