namespace User
{
    ...
    {
        [Function(nameof(HttpUserRegister.UserRegister))]
        [OpenApiOperation(operationId: "UserRegister", tags: new[] { "User" }, Summary = "UserRegister", Description = "This is a description of the rest verbs actions", Visibility = OpenApiVisibilityType.Important)]
        ...
        public async Task<HttpResponseData> UserRegister(
            [HttpTrigger(AuthorizationLevel.Anonymous, "POST", 
            Route = "users/register")] HttpRequestData httpRequestData)
        {
