namespace Store
{
    ...
    {
        [Function(nameof(HttpRetrieveInventory.RetrieveInventory))]
        [OpenApiOperation(operationId: "RetrieveInventory", tags: new[] { "Store" }, Summary = "RetrieveInventory", Description = "This is a description of the rest verbs actions", Visibility = OpenApiVisibilityType.Important)]
        ...
        public async Task<HttpResponseData> RetrieveInventory(
            [HttpTrigger(AuthorizationLevel.Anonymous, "GET", 
            Route = "store/inventory")] HttpRequestData httpRequestData)
        {
