namespace User
{
    ...
    public partial class HttpRequestUser
    {
        [Function(nameof(HttpRequestUser.RequestUser))]
        [OpenApiOperation(operationId: "RequestUser", tags: new[] { "User" }, Summary = "RequestUser", Description = "This is a description of the rest verbs actions", Visibility = OpenApiVisibilityType.Important)]
		...
		[OpenApiResponseWithBody(statusCode: HttpStatusCode.OK, contentType: "application/json", bodyType: typeof(User), Summary = "OK", Description = "OK", CustomHeaderType = typeof(ResponseHeaderOnSuccess))]
        ...
        public async Task<HttpResponseData> RequestUser(
