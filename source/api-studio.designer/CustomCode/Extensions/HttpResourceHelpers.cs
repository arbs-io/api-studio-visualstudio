namespace ApiStudioIO
{
    ...
    {
        internal static HttpResourceHeaderRequest ToHttpResource(this HttpApiHeaderRequest domain)
        {
        ...
        internal static HttpResourceHeaderResponse ToHttpResource(this HttpApiHeaderResponse domain)
        {
            var apiStudioComponent = new HttpResourceHeaderResponse
            {
                ...
                AllowEmptyValue = domain.AllowEmptyValue,
                IsAutoGenerated = domain.IsAutoGenerated,
                IncludeOn = domain.IncludeOn.ToHttpType()
            };
            return apiStudioComponent;
        }

        internal static HttpResourceParameter ToHttpResource(this HttpApiParameter domain)
        {
        ...
        internal static HttpResourceResponseStatusCode ToHttpResource(this HttpApiResponseStatusCode domain)
        {
        ...
        internal static HttpResourceMediaTypeRequest ToHttpResourceRequest(this HttpApiMediaType domain)
        {
        ...
        internal static HttpResourceMediaTypeResponse ToHttpResourceResponse(this HttpApiMediaType domain)
        {
            var DiscreteType = (string.IsNullOrEmpty(domain.DiscreteType) || string.IsNullOrEmpty(domain.SubType)) ?
                HttpTypeMimeAllowedDiscrete.application : (HttpTypeMimeAllowedDiscrete)Enum.Parse(typeof(HttpTypeMimeAllowedDiscrete), domain.DiscreteType);
        ...
        internal static HttpTypeHeaderOnResponse ToHttpType(this HttpApiHeaderResponseOnTypes httpApiHeaderResponseOnTypes)
        {
        ...
        internal static HttpTypeParameterLocation ToHttpType(this HttpApiParameterTypes httpApiParameterTypes)
        {
