namespace ApiStudioIO
{
    ...
    internal static class HttpApiParameterExtension
    {
        ...
        private static ApiStudioComponentParameter CreateManagedApiParameter(CodeGenerationVariableCaseTypes variableCaseType,
            string identifier, string dataType, string description, bool isRequired, HttpApiParameterTypes fromType, bool isAutoGenerated)
        {

            var response = new ApiStudioComponentParameter
            {
        ...
        private static ApiStudioComponentParameter CreateManagedApiParameter(CodeGenerationVariableCaseTypes variableCaseType, ResourceInstance document)
        {
        ...
        private static ApiStudioComponentParameter CreateManagedApiParameter(CodeGenerationVariableCaseTypes variableCaseType, HttpApiParameter parameterCustom)
        {
            return CreateManagedApiParameter(
                variableCaseType,
