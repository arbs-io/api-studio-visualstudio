...
namespace ApiStudioIO
{
	...
	/// </summary>
	internal partial class ApiStudioIOCommandSet : ApiStudioIOCommandSetBase
	{
		/// <summary>
		/// Constructs a new ApiStudioIOCommandSet.
		/// </summary>
		public ApiStudioIOCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class ApiStudioIOCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new ApiStudioIOCommandSetBase.
		/// </summary>
		protected ApiStudioIOCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewApiStudioIOExplorerCommand,
				typeof(ApiStudioIOEditorFactory).GUID);
		...
		{
			ApiStudioIOExplorerToolWindow explorer = this.ApiStudioIOExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected ApiStudioIODocData CurrentApiStudioIODocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as ApiStudioIODocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected ApiStudioIODocView CurrentApiStudioIODocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as ApiStudioIODocView;
			}
		}
		...
		/// </summary>
		protected ApiStudioIOExplorerToolWindow ApiStudioIOExplorerToolWindow
		{
			get
			{
				ApiStudioIOExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(ApiStudioIOExplorerToolWindow), true) as ApiStudioIOExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				ApiStudioIOExplorerToolWindow explorerWindow = this.ApiStudioIOExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class ApiStudioIOClipboardCommandSet : ApiStudioIOClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new ApiStudioIOClipboardCommandSet.
		/// </summary>
		public ApiStudioIOClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class ApiStudioIOClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new ApiStudioIOClipboardCommandSetBase.
		/// </summary>
		protected ApiStudioIOClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
